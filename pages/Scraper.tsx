    ...
    <div className="p-8 h-screen flex flex-col overflow-hidden relative">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-slate-900 p-6 rounded-xl border border-slate-700 flex flex-col items-center justify-center text-center">
                  ...
                  <div className={`text-2xl font-black px-4 py-2 rounded-lg ${selectedCarrier.safetyRating === 'SATISFACTORY' ? 'bg-green-500/20 text-green-400' :
                ...
                <div className="bg-slate-900 p-6 rounded-xl border border-slate-700 flex flex-col items-center justify-center text-center">
                  ...
                  <div className={`text-lg font-bold px-3 py-1 rounded-lg ${selectedCarrier.status.includes('AUTHORIZED') && !selectedCarrier.status.includes('NOT AUTHORIZED')
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={toggleRun}
            className={`flex items-center gap-2 px-8 py-3 rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/25 ${isRunning
                ...
                <tbody className="divide-y divide-slate-800">
                  {scrapedData.length === 0 ? (
                    ...
                    scrapedData.slice().reverse().map((row, i) => (
                      <tr key={i} className="hover:bg-slate-700/50 transition-colors cursor-pointer" onClick={() => setSelectedCarrier(row)}>
